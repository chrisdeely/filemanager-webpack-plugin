...
function archiveAction(command, options) {
  ...
  return function () {
    return new Promise(function (resolve, reject) {
      ...
      if (verbose) {
        console.log('  - FileManagerPlugin: Generating archive for { source: ' + command.source + ', destination: ' + command.destination + ' }');
      }
...
function shellAction(command, options) {
  ...
  return function () {
    return new Promise(function (resolve, reject) {
      ...
      shell.exec(command.command, command.options, function (code, stdout, stderr) {
...
var FileManagerPlugin = function () {
  ...
  createClass(FileManagerPlugin, [{
        ...
        actionOptions.forEach(function (actionItem) {
          switch (actionType) {
            ...
            case 'shell':
              ...
              _this2.processAction(shellAction, actionParams, commandOrder);
    ...
    value: function apply(compiler) {
      ...
      var afterAllComplete = function afterAllComplete(stats) {
        try {
